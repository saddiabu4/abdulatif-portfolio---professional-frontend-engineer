export default {
	...
	about: {
		...
		p1_title: "Performance First",
		p1_desc:
			"I ensure every millisecond counts. Optimization isn't an afterthought.",
		p2_title: "Accessibility",
		p2_desc:
			"Web is for everyone. I build with ARIA and WCAG standards in mind.",
		p3_title: "Visual Flow",
		p3_desc:
			"Motion tells a story. I use subtle animations to guide the user experience.",
	},
	skills: {
	...
	projects: {
		...
		subtitle:
			"A collection of projects spanning across different technologies.",
