			...
			<section className='flex flex-col md:flex-row items-center gap-12'>
				...
				<div className='md:w-2/3 space-y-6'>
					<h1 className='text-4xl sm:text-5xl font-black text-slate-100'>
						{t("about.title")} <span className='text-blue-500'>Me</span>.
					</h1>
					<p className='text-lg sm:text-xl text-slate-400 leading-relaxed italic'>
						"{t("about.bio")}"
					</p>
					<div className='grid grid-cols-2 gap-6 pt-4'>
						<div className='space-y-1 bg-slate-900 p-6 rounded-2xl border border-slate-800'>
							<p className='text-blue-500 font-bold text-3xl'>1+</p>
							<p className='text-[10px] text-slate-500 uppercase font-black tracking-widest'>
								{t("about.exp_years")}
							</p>
						</div>
						<div className='space-y-1 bg-slate-900 p-6 rounded-2xl border border-slate-800'>
							<p className='text-blue-500 font-bold text-3xl'>50+</p>
							<p className='text-[10px] text-slate-500 uppercase font-black tracking-widest'>
